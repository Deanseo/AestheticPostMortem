...
this menthol-infused rub offers no such benefits and is actually bad for your skin, not to mention a _potential permanant damage in your eyes_!

* Manufacturer Warns: "Not for Facial Use"
...
/Note the product description advising customers *not* to use it for a face in the red rectangle./

While some acne treatments might give you a /similar/ 'burning sensation' due to active ingredients like AHA and BHA acids, menthol itself provides no benefits for acne treatment and can harm sensitive facial areas.
...
* why does it happen (draft)
#+ATTR_HTML: :width 250px :class center
[[file:images/product1.jpeg]]
/A theraphist at the shop proudly introducing their new 'acne solution' to customers/.
...
We're also working on an accout in Instagram to share pictures of damaged skins due to the misuse of the products.
